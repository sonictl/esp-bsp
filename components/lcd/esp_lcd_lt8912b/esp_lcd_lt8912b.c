...
static esp_err_t panel_lt8912b_swap_xy(esp_lcd_panel_t *panel, bool swap_axes);
static esp_err_t panel_lt8912b_set_gap(esp_lcd_panel_t *panel, int x_gap, int y_gap);
...
typedef struct {
    ...
    esp_lcd_panel_lt8912b_cfg_t cfg;
    int reset_gpio_num;
    bool reset_level;
    int x_gap;
    int y_gap;
...
esp_err_t esp_lcd_new_panel_lt8912b(const esp_lcd_panel_lt8912b_io_t *io, const esp_lcd_panel_lt8912b_cfg_t *cfg, const esp_lcd_panel_dev_config_t *panel_dev_config, esp_lcd_panel_handle_t *ret_panel)
{
    ...
    ESP_RETURN_ON_FALSE(io && io->main && io->cec_dsi && io->avi && cfg && panel_dev_config && ret_panel, ESP_ERR_INVALID_ARG, TAG, "invalid argument");
    ...
    memcpy(&lt8912b->cfg, cfg, sizeof(esp_lcd_panel_lt8912b_cfg_t));

    lt8912b->io.main = io->main;
    lt8912b->io.cec_dsi = io->cec_dsi;
    lt8912b->io.avi = io->avi;
    lt8912b->reset_gpio_num = panel_dev_config->reset_gpio_num;
    lt8912b->reset_level = panel_dev_config->flags.reset_active_high;
    lt8912b->base.del = panel_lt8912b_del;
    lt8912b->base.reset = panel_lt8912b_reset;
    lt8912b->base.init = panel_lt8912b_init;
    lt8912b->base.invert_color = panel_lt8912b_invert_color;
    lt8912b->base.set_gap = panel_lt8912b_set_gap;
    lt8912b->base.mirror = panel_lt8912b_mirror;
    lt8912b->base.swap_xy = panel_lt8912b_swap_xy;
    lt8912b->base.disp_on_off = panel_lt8912b_disp_on_off;
    lt8912b->base.disp_sleep = panel_lt8912b_sleep;
    *ret_panel = &lt8912b->base;

    return ESP_OK;

err:
    if (lt8912b) {
        panel_lt8912b_del(&lt8912b->base);
    }
    return ret;
}
...
static esp_err_t panel_lt8912b_del(esp_lcd_panel_t *panel)
{
    lt8912b_panel_t *lt8912b = __containerof(panel, lt8912b_panel_t, base);
...
static esp_err_t _panel_lt8912b_send_video_setup(esp_lcd_panel_t *panel)
{
    ...
    esp_lcd_panel_lt8912b_video_timing_t *video_format = &lt8912b->cfg.video_timing;
...
static esp_err_t _panel_lt8912b_send_avi_infoframe(esp_lcd_panel_t *panel)
{
    ...
    esp_lcd_panel_lt8912b_video_timing_t *video_timing = &lt8912b->cfg.video_timing;
...
static esp_err_t panel_lt8912b_init(esp_lcd_panel_t *panel)
{
    ...
    ESP_RETURN_ON_ERROR(_panel_lt8912b_send_mipi_analog(io_main, true), TAG, "send command failed");
...
static esp_err_t panel_lt8912b_invert_color(esp_lcd_panel_t *panel, bool invert_color_data)
{
    ...
    // ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io_main, command, NULL, 0), TAG, "send command failed");
    return ESP_OK;
}
...
static esp_err_t panel_lt8912b_swap_xy(esp_lcd_panel_t *panel, bool swap_axes)
{
    ESP_LOGW(TAG, "Swap XY is not supported in LT8912B driver. Please use SW rotation.");
    return ESP_ERR_NOT_SUPPORTED;
}
...
static esp_err_t panel_lt8912b_sleep(esp_lcd_panel_t *panel, bool sleep)
{
    ...
    //ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io_main, command, NULL, 0), TAG, "io_main tx param failed");
